...
"""python yolomodel.py videoplayback.mp4 \
...
def main():
    ...
    ap.add_argument("--out", default="pose_overlay.mp4",
    ...
    ap.add_argument("--person-only", action="store_true",
                    help="Keep only detections of class 'person'")
    ap.add_argument("--save-json", default=None,
                    help="Optional path to save per-frame keypoints JSON")
    ap.add_argument("--device", default=None,
                    help="Device override, e.g. 'cpu', '0' for GPU0")
    ...
    while True:
        ...
        if r.keypoints is not None and r.boxes is not None and len(r.boxes) > 0:
            ...
            """If we're exporting CSV and haven't captured this
            second yet, store a representative person."""
